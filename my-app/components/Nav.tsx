...
import { Search, Heart, ShoppingCart, User, Menu, X, LayoutDashboard, LogOut } from "lucide-react";
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-3.5 lg:px-10">
          ...
          <div className="hidden items-center gap-4 md:flex">
            ...
            {isLoggedIn ? (
              ...
              <Link
                href="/login"
                className="flex items-center gap-1.5 rounded-full border border-[#B87333]/30 bg-[#D4AF37] px-3 py-1.5 text-[12px] font-semibold text-[#5C4A3D] transition hover:border-[#7A2E22] hover:text-[#7A2E22]"
              >
                Login
              </Link>
            )}
