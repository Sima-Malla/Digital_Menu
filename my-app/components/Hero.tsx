    ...
    <section className="relative h-[660px] min-h-[660px] overflow-hidden">
      ...
      <div className="relative z-10 flex h-full items-center justify-center px-6">
        <div className="max-w-4xl text-center">
          <span className="mb-8 inline-block text-sm font-medium uppercase tracking-[0.45em] text-[#D4AF37]">
          ...
          <h1 className="text-6xl font-light leading-[1.05] tracking-tight text-white md:text-8xl">
            Crafted With
            <br />
            <span className="font-semibold italic text-[#D4AF37]">Passion</span>
          </h1>

          <p className="mx-auto mt-8 max-w-2xl text-lg leading-8 text-white/80">
            Every dish is prepared with seasonal ingredients, authentic
            flavors, and exceptional attention to detail.
          </p>
